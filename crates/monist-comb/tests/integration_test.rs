...
use monist_comb::ast::{GNet, Port, Node, TAG_CON, TAG_NUM, TAG_OPR, TAG_ERA};
...
mod tests {
    ...
    fn test_cycle_garbage_collection() {
        ...
        gnet.nodes[cycle_idx as usize] = Node::new(Port::new(TAG_CON, cycle_idx), Port::new(TAG_CON, cycle_idx));
