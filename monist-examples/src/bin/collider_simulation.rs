...
fn main() {
    ...
    let unstable_logic = Comb::App(Box::new(Comb::Terminal("Omega".to_string())), Box::new(Comb::Terminal("Omega".to_string())));
    ...
    println!("Dimensionless Resonance Magnitude (T_c / T_0): {:.4}", resonance_magnitude);
